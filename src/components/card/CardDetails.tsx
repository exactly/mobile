                ...
                {card && card.provider === "panda" && (
                  ...
                  >
                    <XStack gap="$s4" alignItems="center">
                      <Text emphasized headline letterSpacing={2} backgroundColor="black" fontFamily="$mono">
                    ...
                    <XStack gap="$s5" alignItems="center">
                      <XStack alignItems="center" gap="$s3">
                        <Text caption color="#A1A1A1">
                          Expires
                        </Text>
                        <Text emphasized headline letterSpacing={2} fontFamily="$mono">
                    ...
                    <YStack>
                      <Text emphasized headline letterSpacing={2}>
                        {card.displayName}
                      </Text>
                    </YStack>
                  </YStack>
