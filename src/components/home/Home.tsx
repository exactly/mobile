        ...
        >
          ...
          <View flex={1}>
            <View backgroundColor="$backgroundSoft" padded gap="$s4">
              ...
              {/* TODO add conditions for this alert */}
              <InfoAlert
                title="We’re upgrading all Exa Cards by migrating them to a new and improved card issuer. Your current card works until June 21st, 2025, but upgrading will be required after that."
